...
import '../reg_pages/login_page.dart';
import '../reg_pages/reg_page.dart';
              ...
              child: Column(
                children: [
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Center(
                                                    child: Text(
                                                      "Чат",
                                                      style: TTextStyle.t70024.copyWith(color: TColors.primary),
                                                    )),
                                                ListTile(
                                                  ...
                                                  title: Text(
                                                    ...
                                                    style: TTextStyle.t60014.copyWith(color: TColors.primary),
                                                  ),
                                                  subtitle: Row(
                                                    children: [
                                                      Icon(
                  ...
                  Padding(
                      ...
                      child: Text(
                        "Добро пожаловать!",
                        style: TTextStyle.t40016.copyWith(color: Colors.white),
                      )),
                  Text(
                    "Денис Биткоин",
                    style: TTextStyle.t70024.copyWith(color: TColors.accent),
                  ),
                  Padding(
                                  ...
                                  child: CustomButton(
                                    ...
                                    child: Padding(
                                        ...
                                        child: Text('Сохранить',
                                            style: TTextStyle.t60015.copyWith(
                                                color: TColors.primary))),
                                  ),
                                )
                              ],
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              "мес/год",
                                              style: TTextStyle.t40012.copyWith(
                                                  color: Colors.white),
                                            ),
                                            Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            "15.06.2024",
                                                                            style:
                                                                                TextStyle(fontSize: 14, color: TColors.accent),
                                                                            overflow:
