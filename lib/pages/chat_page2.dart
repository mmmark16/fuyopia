                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child:TextFormField(
                                ...
                                maxLines: 1,
                                style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w400).copyWith(color:Colors.black),
                                cursorColor: Color(0xFFFFFFFF),
                                decoration: InputDecoration(
                                  hintText: "Сообщение",
                                  hintStyle:TextStyle(fontSize: 14.0, fontWeight: FontWeight.w400).copyWith(color: Colors.grey),
